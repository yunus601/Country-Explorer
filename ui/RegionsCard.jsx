...
function RegionsCard({ region = [], src, countries = 0, name }) {
  ...
  return (
    <div className="group w-full max-w-lg overflow-hidden rounded-2xl bg-neutral-card-bg shadow-xs border border-neutral-border hover:shadow-md transition-all duration-200 flex flex-col justify-between">
      ...
      <div className="p-6 space-y-6 flex-1 flex flex-col justify-between">
        <div className="grid grid-cols-2 gap-4 py-2">
          ...
          <div className="space-y-1">
            ...
            <p className="font-bold text-2xl text-text-primary truncate" title={formattedArea}>
              {formattedArea}
            </p>
          </div>
        </div>
        ...
        <Link
          ...
          className="w-full bg-brand-blue hover:bg-blue-900 text-blue-50 font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-colors duration-150 text-lg shadow-2xs group/btn"
        >
